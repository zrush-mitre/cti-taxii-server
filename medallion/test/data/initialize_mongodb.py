...
def reset_db(url="mongodb://root:example@localhost:27017/"):
    ...
    api_root_db["objects"].insert_many([
        ...
        {
            "type": "indicator",
            "id": "indicator--26e949da-3714-403d-bd8c-f3f8ba426b97",
            "created": datetime_to_float(string_to_datetime("2016-11-02T12:30:59.000Z")),
            "modified": datetime_to_float(string_to_datetime("2016-11-02T12:30:59.000Z")),
            "pattern": "[url:value = 'http://x4z9arb.cn/4712']",
            "pattern_type": "stix",
            "spec_version": "2.1",
            "valid_from": datetime_to_float(string_to_datetime("2016-11-03T12:30:59.000Z")),
            "valid_until": datetime_to_float(string_to_datetime("2020-06-19T20:20:20Z")),
            "_collection_id": "61c75ff3-de53-48dd-b38a-332544929d41",
            "_manifest": {
                "date_added": datetime_to_float(string_to_datetime("2020-06-08T12:40:00.000Z")),
                "id": "indicator--26e949da-3714-403d-bd8c-f3f8ba426b97",
                "media_type": "application/stix+json;version=2.1",
                "version": datetime_to_float(string_to_datetime("2016-11-02T12:30:59.000Z")),
            },
        },
        {
            "created": datetime_to_float(string_to_datetime("2014-05-08T09:00:00.000Z")),
